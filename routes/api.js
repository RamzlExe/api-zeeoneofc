...
try {
var zahirr = db.get("ramzi");
} catch (e) {
	console.log('')
}

var creatorList = ['@ramzi','@ramziiigans','@rmzi_ajalah','@ramzianjay', '@ramziganssss','@ramziganteng','@ramziigantengg'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/627764508345 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'ramzigans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'ramzigans') return res.json(loghandler.invalidKey)
